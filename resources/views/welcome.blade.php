  ...
  <body class="nomobile">
    ...
    <section id="header">
        <div class="container">
            <header>
                <!-- HEADLINE -->
                <h1 data-animated="GoIn"><b>Library</b> is under construction...</h1>
            </header>
            <!-- START TIMER -->
            <div id="timer" data-animated="FadeIn">
                <a href="/insertBooks/"><div><img height="100px" width="100px" src="assets/img/slider/addbook.png"><br><b>Add Books</b></div></a>
                <a href="/searchBooks/"><div ><img height="100px" width="100px" src="assets/img/slider/searchbook.png"><br><b>Search Books</b></div></a>
            </div>
            <!-- END TIMER -->
